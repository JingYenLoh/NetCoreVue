<template>
  <div class="hero-body">
    <div class="container">
      ...
      This TimeSheet Management solution is often needed by small business enterprises which provide:
      <ul>
        <li>classes that centers around performing arts (dance, singing etc.)</li>
        <li>tuition on school subjects</li>
      </ul>
      <p></p>
